...
use "C:\xxx\DATA in use\Housework and Mental Health Paper\analyticalfile_hwpaper_v4.dta"
...
*** Set Directory ***
* Change to your own * 
cd "C:\xxE\PAPER VI - Housework and Wellbeing\CSV Export for Graphing"

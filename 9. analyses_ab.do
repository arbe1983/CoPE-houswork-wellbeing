...
*-------------------------------------------------- 
	...
	global fam i.kids03 i.kids46 i.kids717 i.totalnumberchildren i.d_married 
	
	* new, by ariane *
	rec kids03 (2 3=1), gen(d_kids03)
	rec kids46 (2 3=1), gen(d_kids46)
	rec kids717 (2 3 =1), gen(d_kids717)
	global fam d_kids03 d_kids46 d_kids717 c.totalnumberchildren i.d_married 
